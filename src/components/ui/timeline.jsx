        ...
        (<div
            ...
            <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
                ...
                <p
                    ...
                    A mobile app that combines professional networking, job opportunities, hackathon listings, and
                    interactive engagement through polls. Users can create a dynamic profile that includes their
                    portfolio, work experience, and educational background
                </p>
            </div>
